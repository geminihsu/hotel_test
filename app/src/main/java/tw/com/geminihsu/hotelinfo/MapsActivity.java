...
public class MapsActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String location_longitude = bundle.getString(Constants.hotel_longitude);
        String location_latitude= bundle.getString(Constants.hotel_latitude);

        longitude = Double.valueOf(location_longitude);
